...
// user enter/return button to submit name - not working
welcome.onkeydown = function(e) {
    if (e.keyCode == 13) {
...
// submit name when enter is clicked
...
/* user page */ 
let clickMe = docuemnt.getElementById('user-click');
function mainPage () {
    location.href = "main.html";
}
/* end user page */ 
